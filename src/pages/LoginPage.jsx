...
import {
  ...
  InputAdornment, Divider, Chip, alpha
} from "@mui/material";
import {
  Business, Visibility, VisibilityOff, MailOutline, VpnKeyOutlined, Google as GoogleIcon
...
export default function LoginPage() {
  ...
  return (
    ...
    >
      {/* Background */}
      <motion.div style={{ x: bgX, y: bgY, position: "absolute", inset: "-5%" }}>
        <Box
          sx={{
                  ...
                  <Stack spacing={2.4}>
                        ...
                        InputProps={{
                          ...
                          endAdornment: (
                            <InputAdornment position="end">
                              <IconButton onClick={() => setShowPass(v => !v)} edge="end" sx={{ color: alpha("#fff", .8) }}>
                    ...
                    <motion.div variants={itemVariants}>
                      ...
                      <Button
                        ...
                        onClick={() => {/* TODO: gắn Google SSO nếu cần */}}
